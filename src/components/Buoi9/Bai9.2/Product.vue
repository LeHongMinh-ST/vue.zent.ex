          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="Ảnh">
                <ImageInput @changeImage="onChangeImage" @removeImage="removeImage" :url="form.url"/>
              </el-form-item>
            </el-col>
            <el-col :span="11" class="valueWrap">
      ...
      <el-dialog title="Cập nhật sản phẩm" :visible.sync="dialogFormUpdate">
        <el-form label-position="top" label-width="100px"  :model="form">
          <el-row>
            <el-col :span="12">
              <el-form-item label="Ảnh">
                <ImageInput @changeImage="onChangeImage" :url="form.url"/>
              </el-form-item>
            </el-col>
            <el-col :span="11" class="valueWrap">
              <el-form-item label="Tên sản phẩm">
...
import ImageInput from "@/components/Buoi9/Bai9.2/ImageInput";
